    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="max-w-md w-full bg-card rounded-2xl shadow-xl shadow-primary/5 p-8 border border-border">
        <div className="flex justify-center mb-6">
          <Image src="/logo.png" alt="Kallar Central Sports Club crest" width={100} height={100} className="object-contain" />
        </div>
        <h2 className="text-2xl text-center text-card-foreground mb-2">Admin Login</h2>
        <p className="text-sm text-center text-muted-foreground mb-8">Sign in to manage Kallar Central Sports Club</p>
