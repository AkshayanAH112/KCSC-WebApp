      ...
      <div className="relative max-w-[1280px] mx-auto px-5 md:px-16 pointer-events-auto">
        ...
        {posts === null ? (
          ...
          >
            {posts.slice(0, 6).map((post) => ( // Only show top 6 in the horizontal scroll
              ...
              >
                ...
                <div className="p-6 flex flex-col h-full">
                  ...
                  <Link 
                    href={`/news/${post.slug}`}
                    className="text-primary font-semibold text-sm self-start flex items-center gap-1 hover:gap-2 transition-all mt-auto pointer-events-auto"
                  >
            ...
            <Link 
              href="/news"
              className="shrink-0 snap-start flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-outline-variant/50 hover:bg-surface-container-low transition-colors cursor-pointer group w-[85vw] sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] min-h-[300px] pointer-events-auto"
            >
