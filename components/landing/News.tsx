...
export default function News() {
  ...
  const dummyNews = [
    {
      id: 1,
      title: "KCSC Secures Championship Victory in Final Over",
      date: "October 24, 2026",
      excerpt: "In a thrilling finale that went down to the very last ball, Kallar Central Sports Club claimed the regional championship trophy...",
    ...
    },
    {
      ...
      excerpt: "We are excited to announce our new intensive junior coaching clinics starting this winter, designed to build the next generation of KCSC talent.",
      category: "Club News",
    },
    {
      id: 3,
      title: "Annual General Meeting 2026 Details",
      date: "October 05, 2026",
      excerpt: "All club members are invited to attend the AGM where we will discuss the roadmap for the upcoming season and vote on committee positions.",
      category: "Announcement",
    },
    {
      id: 4,
      title: "Local Derby Ends in a Nail-biting Draw",
      date: "September 28, 2026",
      excerpt: "The much anticipated clash against our cross-town rivals ended in a spectacular draw as light faded on the final day.",
      category: "Match Report",
    },
  ];
