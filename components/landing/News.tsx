    ...
    >
      ...
      <div className="relative max-w-[1280px] mx-auto px-5 md:px-16">
        ...
        {posts === null ? (
          ...
          <div className="flex flex-col items-center justify-center p-12 bg-surface-container-low rounded-3xl border border-outline-variant/30 text-on-surface-variant h-[400px]">
            <p>{t("no_news")}</p>
          </div>
        ) : (
