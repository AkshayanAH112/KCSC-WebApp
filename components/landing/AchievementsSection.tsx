...
export default function AchievementsSection() {
  ...
  return (
    // Same extra-tall wrapper as ProgramsSection — gives this card its own
    // bounded hold/release window instead of sticking indefinitely over
    // whatever follows it (Gallery, News, etc.).
    <div className="relative h-[200vh]">
      <section
        id="achievements"
        className="sticky top-0 z-20 h-screen overflow-hidden bg-surface-container flex flex-col justify-center py-24 md:py-32 shadow-elevated"
      >
